...
CREATE TABLE `db_demand_manager` (
  `demand_id` varchar(32) NOT NULL COMMENT '主键32位',
  `demand_name` varchar(100) DEFAULT NULL COMMENT '需求标题',
  `demand_desc` varchar(255) DEFAULT NULL COMMENT '需求描述',
  `demand_type` int(1) DEFAULT NULL COMMENT '需求类型  1-新增 2-修改 3-优化 ',
  `priority` int(1) DEFAULT NULL COMMENT '优先级 1-紧急、2-高、3-中、4-低',
  `demand_status` int(1) DEFAULT NULL COMMENT '状态  1-计划中;2-已下发;3-进行中;4-已完成;5-暂缓;6-终止/移除；7-已发布；8-已逾期',
  `sponsor` varchar(60) DEFAULT NULL COMMENT '发起人',
  `sponsor_time` varchar(32) DEFAULT NULL COMMENT '发起时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='需求管理';

-- ----------------------------
-- Records of db_demand_manager
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE `db_member_manager` (
  ...
  `add_time` varchar(32) DEFAULT NULL COMMENT '加入时间',
  `release_time` varchar(32) DEFAULT NULL COMMENT '释放时间',
  `creater_user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建人id',
  `creater_time` datetime DEFAULT NULL COMMENT '创建时间',
  `modifier_user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '修改人id',
  `modifier_time` datetime DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `db_task_member` (
  ...
  `mmember_name` varchar(100) DEFAULT NULL COMMENT '成员姓名',
  PRIMARY KEY (`task_member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='任务成员关联表';

-- ----------------------------
-- Records of db_task_member
-- ----------------------------
BEGIN;
COMMIT;
