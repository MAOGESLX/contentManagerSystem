 ...
 */
@Component
@PropertySource("classpath:mybatisDruidDataSource.properties")
@ConfigurationProperties(prefix = "mybatis-druid-dataSource")
public class MybatisDruidDataSourceProperties {

    private MybatisDruidDataSourceProperties(){}
    ...
    public String toString() {
        return "MybatisDruidDataSourceProperties{" +
